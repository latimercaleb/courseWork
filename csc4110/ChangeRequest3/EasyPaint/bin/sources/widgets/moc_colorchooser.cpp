...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ColorChooser_t, stringdata) + ofs \
...
const QMetaObject ColorChooser::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_ColorChooser.data,
      qt_meta_data_ColorChooser,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ColorChooser.stringdata))
