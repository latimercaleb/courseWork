...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PaletteButton_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 36, 5)
    ...
    "PaletteButton\0colorPicked\0\0setColor\0"
    "color"
};
...
const QMetaObject PaletteButton::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_PaletteButton.data,
      qt_meta_data_PaletteButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PaletteButton.stringdata))
