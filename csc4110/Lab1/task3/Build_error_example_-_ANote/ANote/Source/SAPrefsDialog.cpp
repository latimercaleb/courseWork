...
// Language
	((CButton *)GetDlgItem (IDOK))->SetWindowText (CTranslate::ReadString (36, _T("OK")));
	((CButton *)GetDlgItem (IDCANCEL))->SetWindowText (CTranslate::ReadString (37, _T("Cancel")));
...
bool CSAPrefsDialog::AddPage(CSAPrefsSubDlg &dlg, const TCHAR *pCaption, CSAPrefsSubDlg* pDlgParent /*=NULL*/)
{
	if (m_hWnd)
	{
