...
int CBase64::GetLength () const
{
	return m_nDDataLen;
}

char *CBase64::DecodedMessage() const 
{ 
	return (char *) m_pDBuffer;
}

char * CBase64::EncodedMessage() const
{ 
...
void CBase64::Encode(char * szMessage)
{
	if(szMessage != NULL)
...
void CBase64::Decode(char * szMessage)
{
	if(szMessage != NULL)
