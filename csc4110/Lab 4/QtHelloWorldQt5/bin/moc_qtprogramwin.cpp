...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QtProgramWin_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 56, 14)
    ...
    "setNewNumber\0setOperation\0setlineEditNum"
};
...
void QtProgramWin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setNewNumber((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->setOperation((*reinterpret_cast< char(*)>(_a[1]))); break;
        case 3: _t->setlineEditNum((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject QtProgramWin::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_QtProgramWin.data,
      qt_meta_data_QtProgramWin,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QtProgramWin.stringdata))
