...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PaletteBar_t, stringdata) + ofs \
...
const QMetaObject PaletteBar::staticMetaObject = {
    { &QToolBar::staticMetaObject, qt_meta_stringdata_PaletteBar.data,
      qt_meta_data_PaletteBar,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PaletteBar.stringdata))
