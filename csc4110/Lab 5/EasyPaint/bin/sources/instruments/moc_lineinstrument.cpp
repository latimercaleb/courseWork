...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LineInstrument_t, stringdata) + ofs \
...
const QMetaObject LineInstrument::staticMetaObject = {
    { &AbstractInstrument::staticMetaObject, qt_meta_stringdata_LineInstrument.data,
      qt_meta_data_LineInstrument,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LineInstrument.stringdata))
