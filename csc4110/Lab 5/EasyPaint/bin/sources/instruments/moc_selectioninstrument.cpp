...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SelectionInstrument_t, stringdata) + ofs \
...
const QMetaObject SelectionInstrument::staticMetaObject = {
    { &AbstractSelection::staticMetaObject, qt_meta_stringdata_SelectionInstrument.data,
      qt_meta_data_SelectionInstrument,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SelectionInstrument.stringdata))
