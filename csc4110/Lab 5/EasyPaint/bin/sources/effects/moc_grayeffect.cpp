...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GrayEffect_t, stringdata) + ofs \
...
const QMetaObject GrayEffect::staticMetaObject = {
    { &AbstractEffect::staticMetaObject, qt_meta_stringdata_GrayEffect.data,
      qt_meta_data_GrayEffect,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GrayEffect.stringdata))
