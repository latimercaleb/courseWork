...
namespace NS_OBJLOADER
{
	...
	*/
	struct MESH
	{
		deque<VEC3> m_Positions;
		deque<VEC3> m_Normals;
	...
	*/
	bool LoadOBJFile (const char *szFile, MESH& Mesh, map<string, MATERIAL>& Materials, const char* szMaterialBasePath = "", bool bSortByMaterial = true, bool bIgnoreMaterials = false);
